---
title: "Status Notebook Assignment 03"
...
* RCS ID: woodsa4
* Project Name: woodsa4_assignment03
* Summary of work since last week 

    * The focus of this work is to study and experiment with both heatmaply and heatmap.2 to determine the best graphical representation of our hockey data to identify the following:
      * The best format from both heatmap.2 and heatmaply to visualize our dataset.
      * Which features are the most/least useful in predicting goal outcomes?
      * Is it possible, with some method of dendrogram clustering, to see what features may define different types of goal success or failure? 
